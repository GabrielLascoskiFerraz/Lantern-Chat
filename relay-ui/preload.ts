...
contextBridge.exposeInMainWorld('relayUi', {
  ...
  selectConvertedBackup: () => ipcRenderer.invoke('relay-ui:selectConvertedBackup'),
  importConvertedBackup: (bundlePath: string) => ipcRenderer.invoke('relay-ui:importConvertedBackup', bundlePath),
